...
export function DashboardSidebar() {
  ...
  return (
    <Sidebar variant="sidebar" className="border-r bg-card border-border/40 shadow-sm">
          ...
          <SidebarMenu>
            ...
            <SidebarMenuItem>
              <Link href="/dashboard/backrooms/map" passHref legacyBehavior>
                <SidebarMenuButton isActive={pathname === "/dashboard/backrooms/map"} tooltip="Map">
      ...
      <SidebarFooter className="p-4 border-t border-border/40">
        <div className="flex items-center justify-between">
          <form action={handleSignOut} className="contents">
