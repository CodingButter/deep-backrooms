      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div 
            ...
            className="absolute right-0 mt-2 w-40 z-50 rounded-md shadow-lg border border-border bg-[hsl(var(--color-card))] overflow-hidden electric:shadow-[0_0_15px_rgba(var(--color-primary),0.3)]"
          >
            <div className="py-1" role="menu" aria-orientation="vertical">
              {themeOptions.map((option) => (
                <motion.button
                  ...
                  className={`${
                    theme === option.value ? "bg-[hsl(var(--color-primary)/0.1)] font-medium" : ""
